...
import 'package:digitalhunt/Views/pages/home_navigation.dart';
  ...
  return PageViewModel(
    titleWidget: Column(
      children: <Widget>[
        Text(
          title,
          style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, letterSpacing: -0.7, wordSpacing: 1, color: Colors.black),
        ).tr(),
        SizedBox(height: 8),
        Container(
          height: 3,
